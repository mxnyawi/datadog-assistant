...
const CSS = `
  * { margin:0; padding:0; box-sizing:border-box; -webkit-font-smoothing:antialiased; }
  ...
  #menubar { position:absolute; top:0; left:0; right:0; height:46px; z-index:50;
    ...
    color:#fff; background:rgba(28,28,32,0.55); backdrop-filter:blur(34px); }
  ...
  /* ---- glass panels ---- */
  .panel { position:absolute; background:rgba(40,40,46,0.92); backdrop-filter:blur(42px) saturate(1.5);
  ...
  .graph .gline { fill:none; stroke:#ff7a7a; stroke-width:3; stroke-linecap:round; stroke-linejoin:round;
    filter:drop-shadow(0 0 6px rgba(255,90,90,0.6)); stroke-dasharray:1; stroke-dashoffset:1; }
  ...
  .banner { position:absolute; display:flex; gap:16px; align-items:center; color:#fff; z-index:30;
    background:rgba(46,46,52,0.86); backdrop-filter:blur(42px) saturate(1.5); border-radius:24px;
  ...
  .modal { position:absolute; border-radius:24px; padding:36px 34px 28px; text-align:center; color:#fff; z-index:40;
    background:rgba(50,50,56,0.96); backdrop-filter:blur(50px); border:1px solid rgba(255,255,255,0.18);
  ...
  .curarrow { position:absolute; width:42px; height:42px; right:34px; top:50%; margin-top:-21px; z-index:60;
    filter:drop-shadow(0 4px 8px rgba(0,0,0,0.5)); pointer-events:none; }
  ...
  .cap .pill { display:inline-block; padding:14px 34px; border-radius:999px; font-weight:700; letter-spacing:-0.4px;
    background:rgba(16,16,26,0.6); backdrop-filter:blur(16px); border:1px solid rgba(255,255,255,0.14);
